export const carErrorMessages = Object.freeze({
    ...
    NOT_VALID_VIN_MESSAGE: "The VIN can only contain latin letters, digits and spaces.",
    NOT_VALID_VIN_LENGTH_MESSAGE: "Length should be 17 symbols.",
    NOT_VALID_COLOR_MESSAGE: "The color can only contain latin letters.",
